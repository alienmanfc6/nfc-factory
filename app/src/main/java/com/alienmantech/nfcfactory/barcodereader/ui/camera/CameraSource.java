 ...
 * {@link com.alienmantech.nfcfactory.barcodereader.ui.camera.CameraSource.Builder#setRequestedFps(float)} to specify a frame rate that works well with
...
public class CameraSource {
    ...
    public static class Builder {
        ...
        private com.alienmantech.nfcfactory.barcodereader.ui.camera.CameraSource mCameraSource = new com.alienmantech.nfcfactory.barcodereader.ui.camera.CameraSource();
         ...
         */
        public com.alienmantech.nfcfactory.barcodereader.ui.camera.CameraSource build() {
    ...
    public com.alienmantech.nfcfactory.barcodereader.ui.camera.CameraSource start() throws IOException {
        synchronized (mCameraLock) {
            if (mCamera != null) {
                return this;
            }
     ...
     */
    @RequiresPermission(Manifest.permission.CAMERA)
    public com.alienmantech.nfcfactory.barcodereader.ui.camera.CameraSource start(SurfaceHolder surfaceHolder) throws IOException {
        synchronized (mCameraLock) {
            if (mCamera != null) {
                return this;
            }
    ...
    public boolean supportFlashMode(@FlashMode String mode) {
        synchronized (mCameraLock) {
            if (mCamera != null && mode != null) {
                Camera.Parameters params = mCamera.getParameters();
                ...
                if (params != null) {
                    List<String> flashModes = params.getSupportedFlashModes();
                    if (flashModes != null) {
                        return flashModes.contains(mode);
                    }
                }
            }
